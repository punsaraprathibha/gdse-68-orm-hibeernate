...
public class GetVsLoad {
    ...
    public static void main(String[] args) {
        ...
        Customer getCustomer = getSession
                .get(Customer.class, 1);
        System.out.println("Customer Id of Get: "
                + getCustomer.getId());
        System.out.println("Customer Name of Get: "
                + getCustomer.getName());
        getSession.close();
